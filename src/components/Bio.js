...
const Bio = () => {
  return (
    <div className="bio">
        ...
        he seamlessly weaves his passions into the fabric of his life. A podcaster, a vlogger, an avid traveler, and a spontaneous cook who often abandons recipes, 
